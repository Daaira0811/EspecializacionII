...
class VerMasGeneral extends StatefulWidget {
  const VerMasGeneral({super.key});

  @override
  State<StatefulWidget> createState() => _VerMasGeneralState();
}

class _VerMasGeneralState extends State<VerMasGeneral> {
  int index = 0;
  NavBar? myNavBar;
  @override
  void initState() {
...
Widget dia1DisplayPlus(context) {
  final List<String> categoriaGasto = <String>[
    'Trabajo', 
  ];
  final List<String> cuenta = <String>[
...
Widget dia2DisplayPlus(context) {
  final List<String> categoriaGasto = <String>[
    'Ropa', 
  ];
  final List<String> cuenta = <String>[
